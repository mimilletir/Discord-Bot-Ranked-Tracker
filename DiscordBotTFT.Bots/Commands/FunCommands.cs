using DiscordBotTFT.Attributes;
using DiscordBotTFT.Bots.Handlers.Dialogue;
...
namespace DiscordBotTFT.Bots.Commands
{
    public class FunCommands : BaseCommandModule
    {
        ...
        [RequireCategories(ChannelCheckMode.Any, "Salons textuels")]
        ...
        public async Task Add(CommandContext ctx, [Description("First Number")] int numberOne, [Description("First Number")] int numberTwo)
        {
            await ctx.Channel
